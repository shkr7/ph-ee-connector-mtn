...
public class ChannelToRtpCallback {
    ...
    public RtpCallbackResponseDTO convertToRtpCallbackResponseDTO(String channelDto) throws Exception {
        ...
        RtpCallbackResponseDTO dto =  RtpCallbackResponseDTO.builder()
    ...
    public RtpCallbackResponseDTO prepareFailureDto(RtpCallbackResponseDTO dto) {
        dto.setFinancialTransactionId(null);
        dto.setStatus("FAILED");
        dto.setReason("APPROVAL_REJECTED");
